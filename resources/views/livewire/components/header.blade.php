<nav class="fixed z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
    <div class="px-3 py-3 lg:px-5 lg:pl-3"wire:ignore>
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="/" class="flex ml-2 md:mr-24">
                    <img src="/images/logo.svg" class="mr-3 w-[190px] dark:hidden" alt="Logo">
                    <img src="/images/logo_white.svg" class="mr-3 h-8 w-[190px] hidden dark:block" alt="Logo">
                </a>

                <form action="#" method="GET" class="hidden lg:block lg:pl-3.5">
                    <label for="topbar-search" class="sr-only">Поиск заявки</label>
