<div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
    <div class="items-center justify-between lg:flex">
        <div class="mb-4 lg:mb-0">
            <h3 class="mb-2 text-xl font-bold text-gray-900 dark:text-white">Заявки</h3>
            <span class="text-base font-normal text-gray-500 dark:text-gray-400">
                                Список открытых заявок от пользователей
                            </span>
        </div>
        <div class="items-center sm:flex">
            <div class="flex items-center">
                ...
                <div id="dropdown" class="z-10 hidden w-56 p-3 bg-white rounded-lg shadow dark:bg-gray-700" data-popper-placement="bottom" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(884px, 3123.2px, 0px);">
                    ...
                    <ul class="space-y-2 text-sm" aria-labelledby="dropdownDefault">
                        ...
                        <li class="flex items-center">
                            ...
                            <label for="dell" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100"> In
                                progress (56) </label>
                        </li>
                        ...
                        <li class="flex items-center">
                            ...
                            <label for="asus" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100"> In
                                review (97) </label>
                        </li>
                    </ul>
                </div>
